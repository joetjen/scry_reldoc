defmodule Scry.Reldoc.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      # Scry.Reldoc.parse/1 and Scry.Reldoc.Executor.run/3 both
      # delegate straight to scry_document's own equivalents --
      # `relational` is a degenerate kind (§2: no grammar/execution
      # vocabulary of its own), so this composite's own grammar is
      # exactly scry_document's own, with nothing added.
  ...
  defp package do
    [
      licenses: ["MIT"],
      links: %{"GitHub" => "https://github.com/joetjen/scry_reldoc"},
  ...
  defp docs do
    [
      main: "readme",
      source_url: "https://github.com/joetjen/scry_reldoc",
